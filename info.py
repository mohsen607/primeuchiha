...
API_ID = int(environ.get('API_ID', '20107047'))
API_HASH = environ.get('API_HASH', '3176a12efbf140eb8bca731862bceea9')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1641136130').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002038784813').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mohsenrather:<password>@prime01.kdgpuo3.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002110585495)) 
...
URL = "https://dewo.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://dewo.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://dewo.onrender.com/".format(FQDN)
else:
    URL = "https://dewo.onrender.com/".format(FQDN)

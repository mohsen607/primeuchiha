...
URL = "https://demo-bot-fmvf.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demo-bot-fmvf.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demo-bot-fmvf.onrender.com/".format(FQDN)
else:
    URL = "https://demo-bot-fmvf.onrender.com/".format(FQDN)
